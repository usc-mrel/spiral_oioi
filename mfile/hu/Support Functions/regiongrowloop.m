...
% datafull = imfilter(datafull, ones(10) / 100, 'same');
...
%     smed = s(600);
    ...
    % display super pixels
%     imageMRI(sos(datafull));
%     imageMRI(fm_hold);
%     hold on
%     for i = 1:sup_pix_size
%         plot(med_val_loc(2, i) * (xrat*2)-1, med_val_loc(1, i) * (yrat*2)-1, '*')
%     end
    
% STEP 5 - Find center of mass (COM) Super Pixel
    if Nz == 1
...
%                 drawnow
            ...
            temp2 = temp2 / temp2_sum; % weighting by Signal intensity
